(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  class Gui {
    ...
    setGrid = (grid) => {
      ...
      window.addEventListener(events.load, () => {
        ...
        this.onSetWallsButtonClicked();
        this.onEraserButtonClicked();
      });
    };
    ...
    setEraser = (row, col) => {
      console.log(`Eraser: (${col}, ${row})`);
      //this.eraser.push({ x: col, y: row });
      this.matrix[row][col] = 0;  
      this.setElement(col, row, cellTypes.plain)
    ...
    startAlgorithmNoProcess = () => {
      console.log("Starting algorithm without process");
      ...
      document
        ...
        .addEventListener(events.click, () => {
          ...
          if(document.getElementById('no').checked) { 
            if (!this.alreadyExecuted) this.startAlgorithmNoProcess();
          }
      ...
      document
        ...
        .addEventListener(events.click, () => {
          ...
          if(this.choosingStartPoint){
            ...
            this.choosingWalls = false;
            this.choosingEraser = false;
          }
          console.log("choosingStart: " + this.choosingStartPoint);
          console.log("choosingEnd: " + this.choosingEndPoint);
          console.log("choosingWalls: " + this.choosingWalls);
          console.log("choosingEraser: " + this.choosingEraser);
      });
    };
    ...
    onChooseEndPointButtonClicked = () => {
      ...
      /**
     * Executed once set walls button is clicked
     */
    onSetWallsButtonClicked = () => {
      document
        .getElementById(htmlElement.setWallsButton)
        .addEventListener(events.click, () => {
          console.log("Set walls button clicked");
          if(this.choosingWalls){
            this.choosingWalls = false;
          } else {
            this.choosingWalls = true;
            this.choosingEndPoint = false;
            this.choosingStartPoint = false;
            this.choosingEraser = false;
         }
      ...
      /**
     * Executed once eraser button is clicked
     */
    onEraserButtonClicked = () => {
      document
        .getElementById(htmlElement.eraserButton)
        .addEventListener(events.click, () => {
          console.log("Eraser button clicked");
          if(this.choosingEraser){
            this.choosingEraser = false;
          } else {
            this.choosingEraser = true;
            this.choosingWalls = false;
            this.choosingEndPoint = false;
            this.choosingStartPoint = false;
         }
  ...
  let grid = createGrid(24, 24, function (el, row, col, i) {
      ...
      } else if(gui.choosingWalls) {
        gui.setWall(col, row);
      } else if(gui.choosingEraser) {
        gui.setEraser(col, row);
      } else {
        //gui.setWall(col, row);
      }
    });
